...
contract DistributorTest is Test {
    ...
    function setUp() public {
        ...
        address proxy = Upgrades.deployUUPSProxy(
            ...
            abi.encodeCall(Distributor.initialize, (signer, owner, address(token)))
        );
    ...
    function test_CreateAndClaimAndRefund() public {
        ...
        distributor.createRedPacket(uuid, githubIds, amounts);
        vm.stopPrank();
        ...
        (uint8 v, bytes32 r, bytes32 s) = vm.sign(uint256(1), ethSignedMessageHash);
